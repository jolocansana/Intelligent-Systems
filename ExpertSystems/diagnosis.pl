...
write('My name is Baymax and I\'m here to help.'), nl,
hypothesis(Disease),
...
hypothesis(tonsillitis) :- tonsillitis, !.
...
write('3: Antibiotics'),
nl,
write('4: Analgesic (spray)'),
nl,
write('Penicillin V: 250mg 2 times a day for 10 days for kg < 27 and 500 mg for kg>27'),
nl,nl.
